...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--lr_m', type=float, default=0.0002, help='initial learning rate for adam')
        ...
        parser.add_argument('--lambda_gan', type=float, default=1.0, help='weight for feat loss')
        # parser.add_argument('--lambda_sobel', type=float, default=100.0, help='weight for sobel loss')
        # parser.add_argument('--lambda_ssim', type=float, default=100.0, help='weight for ssim loss')
        # parser.add_argument("--alpha", type=float, default=1.5, help="hyperparameter of restoring force, default is 0.12")
